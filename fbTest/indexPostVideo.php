...
$data2=['title'=>'My first video' , 'description' => 'Windows 7 is the owner of this video','source'=>$fb->videoToUpload('wildlife.mp4'),];
try
{
	$response=$fb->post('/112510383726603/videos',$data2,
...
$graphNode = $response->getGraphNode();		// display everything in the browser
		...
		$loginUrl = $helper->getLoginUrl( 'http://localhost/fbTest/indexPostVideo.php', $permissions );///aici trebuie schimbat URL pt localhost. Al meu este cel definit inainte
