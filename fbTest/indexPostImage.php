<?php
	...
	if ( $isLoggedIn ) { // logged in
	  ...
	  $name='gerald.png';
     $data= ['message' => 'Witcher', 'source' => $fb->fileToUpload($name),];
       try {
  // Returns a `FacebookFacebookResponse` object
	  $response=$fb->post('/112510383726603/photos',$data,
...
$graphNode = $response->getGraphNode();	
		...
		$loginUrl = $helper->getLoginUrl( 'http://localhost/fbTest/indexPostImage.php', $permissions );///aici trebuie schimbat URL pt localhost. Al meu este cel definit inainte
